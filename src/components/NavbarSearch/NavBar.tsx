...
const NavBar = () => {
  return (
<nav className=" m-auto bg-black w-3/4 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-black-900">
  ...
  <div className="flex md:order-2">
    ...
    <div className="hidden relative md:block">
      ...
      <input type="text" id="search-navbar" className="block p-2 pl-10 w-full text-black-900 bg-black-50 rounded-lg border border-white-300 sm:text-sm focus:ring-white-500 focus:border-white-500 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
    </div>
